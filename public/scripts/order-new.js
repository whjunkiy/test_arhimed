...
// add order process fee
        ...
        $('#choose-pharmacy-add' + data_id).on("change", function () {
            $('.pharm').hide();
            $('.none').hide();
            console.log('selected pharm: ' + $(this).val());
            $('#select-order-template-add' + data_id).val($(this).val())
...
// add order process fee
        ...
        $('#choose-pharmacy-add_2_' + data_id).on("change", function () {
            $('.pharm').hide();
            $('.none').hide();
            console.log('selected pharm_2: ' + $(this).val());
            $('#select-order-template-add_2_' + data_id).val($(this).val())
...
// add order process fee
                ...
                $('.ctmedcost').html(parseFloat(tm).toFixed(2));
                $('.totmeds').val(parseFloat(tm).toFixed(2));
                console.log('Change Add template: ' + tm);
